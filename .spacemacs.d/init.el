...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "%I@%S")
   dotspacemacs-frame-title-format "%a [%t] - Emacs"
...
before packages are loaded."
  (setq cdlatex-auto-help-delay 10)
  ...
  ;; Org LaTeX Extra Packages
  (setq org-latex-packages-alist
        '(("" "esint" t)
          ("" "extarrows" t)))

  ;; CDLaTeX Custom Command
  ...
  ;; turn on org-cdlatex-mode automatically
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (winum restart-emacs paradox spinner open-junk-file flx-ido ace-link ws-butler uuidgen smartparens move-text lorem-ipsum link-hint hungry-delete expand-region eval-sexp-fu highlight clean-aindent-mode aggressive-indent org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download htmlize gnuplot fcitx pyim pyim-basedict pangu-spacing find-by-pinyin-dired ace-pinyin pinyinlib wgrep smex ivy-hydra counsel-projectile counsel swiper ivy cdlatex auctex spaceline s dash powerline popwin neotree hl-todo golden-ratio fill-column-indicator fancy-battery which-key use-package pcre2el macrostep hydra helm-themes helm-swoop helm-projectile helm-mode-manager helm-make projectile pkg-info epl helm-flx flx helm-descbinds helm-ag exec-path-from-shell evil-visualstar evil-escape evil goto-chg undo-tree elisp-slime-nav diminish bind-map bind-key auto-compile packed ace-window ace-jump-helm-line helm avy helm-core popup async))))
(custom-set-faces
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smeargle orgit magit-svn magit-gitflow gitignore-templates gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link evil-magit magit magit-popup git-commit ghub with-editor winum restart-emacs paradox spinner open-junk-file flx-ido ace-link ws-butler uuidgen smartparens move-text lorem-ipsum link-hint hungry-delete expand-region eval-sexp-fu highlight clean-aindent-mode aggressive-indent org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download htmlize gnuplot fcitx pyim pyim-basedict pangu-spacing find-by-pinyin-dired ace-pinyin pinyinlib wgrep smex ivy-hydra counsel-projectile counsel swiper ivy cdlatex auctex spaceline s dash powerline popwin neotree hl-todo golden-ratio fill-column-indicator fancy-battery which-key use-package pcre2el macrostep hydra helm-themes helm-swoop helm-projectile helm-mode-manager helm-make projectile pkg-info epl helm-flx flx helm-descbinds helm-ag exec-path-from-shell evil-visualstar evil-escape evil goto-chg undo-tree elisp-slime-nav diminish bind-map bind-key auto-compile packed ace-window ace-jump-helm-line helm avy helm-core popup async)))
 '(paradox-github-token t)
 '(spacemacs-theme-custom-colors (quote ((act2 . "#222226")))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
